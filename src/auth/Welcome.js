...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-gray-10 to-gray-50 px-4">
      {/* Back button — same vibe as Verify */}
      ...
      <main className="w-full max-w-xl text-center mb-[10%]">
        <h1 className="text-5xl font-muller font-bold text-gray-900">
          Добро пожаловать в Alem!
        </h1>
        <p className="mt-2 text-gray-700 font-muller">
          С какой целью вы к нам пришли?
        </p>
        ...
        <div className="mt-8 flex flex-col items-stretch gap-4">
          ...
          <button
            ...
            className="w-full rounded-2xl border-2 border-gray-100 bg-white p-6 text-left shadow-sm
                       transition hover:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-200
                       active:scale-[0.99]"
          >
            <div className="flex items-center">
              ...
              <div className="flex-1">
                <h3 className="mb-1 font-muller font-medium text-zinc-900 sm:text-xl">
                  Стать репетитором
                </h3>
          ...
          <p className="mt-2 text-xs text-gray-500">
            Вы всегда сможете изменить выбор позже в настройках профиля.
          </p>
        </div>
      </main>
    </div>
